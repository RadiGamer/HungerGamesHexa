...
/*
    ...
    public void onPlayerDeath(PlayerDeathEvent event){
        ...
        String killerName = "sus propios motivos";
        ...
        String playerDeathMessage = String.format(playerDeath, event.getPlayer().getName(),killerName, jugadores.getEntries().size());
